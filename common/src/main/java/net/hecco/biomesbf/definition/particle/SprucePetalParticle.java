package net.hecco.biomesbf.definition.particle;
...
public class SprucePetalParticle extends TextureSheetParticle {
    private float rotation;
    private final float randomThing;
    private final float otherRotation;

    protected SprucePetalParticle(ClientLevel world, double x, double y, double z, SpriteSet spriteProvider) {
        super(world, x, y, z);
        this.setSprite(spriteProvider.get(this.random.nextInt(7), 7));
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel clientWorld, double x, double y, double z, double xd, double yd, double zd) {
            return new SprucePetalParticle(clientWorld, x, y, z, sprites);
        }
    }
}